...
export default function DolomiteHero() {
  return (
    <section className="relative h-screen w-full overflow-hidden">
      <video
        className="absolute inset-0 h-full w-full object-cover"
        src="/dolomite/video.mp4"
        autoPlay
        muted
        playsInline
        preload="metadata"
      ...
      <div className="relative z-10 flex h-full flex-col justify-between px-6 pt-28 pb-16">
        ...
        >
          ...
          <span className="font-(family-name:--font-inter) shrink-0 text-[10px] uppercase tracking-[0.35em] text-white/80">
            Est. 1897 · Belluno, Italia
          </span>
          <div className="h-px flex-1 bg-white/40" />
        </motion.div>

        {/* DOLOMITE wordmark + tagline */}
        <div className="mx-auto w-full max-w-7xl text-center">
          <motion.h1
            className="font-(family-name:--font-manrope) text-[18vw] font-thin leading-none tracking-tighter text-white md:text-[14vw]"
          ...
          >
            Italienskt bergshantverk sedan 1897. Teknologi för dem som tar äventyret på allvar.
          </motion.p>
        </div>
